...
export default class TopNavigation extends LitElement {
  ...
  getPages() {
    ...
    return staticPages.concat([{"name":"ballot","title":"Basic voting using a ballot","description":"Create a simple voting system with a ballot.","category":"Voting","route":"/ballot"}]); 
  }
